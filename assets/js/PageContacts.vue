    ...
    <nav aria-label="Contacts pagination" class="mx-auto mt-5 mb-10 d-flex justify-content-center">
      <ul class="pagination pagination-lg">
        <li
            ...
            @click="contacts.pages.current > 1 ? fetchContacts(contacts.pages.current - 1) : null"
        >
        ...
        <template v-for="(pageNumber, index) in generatePaginationPages()">
          ...
          <li
              ...
              @click="fetchContacts(pageNumber)"
          >
                    <span class="page-link">
                        {{ pageNumber }}
                    </span>
        ...
        <li
            ...
            @click="contacts.pages.current < contacts.pages.total ? fetchContacts(contacts.pages.current + 1) : null"
        >
